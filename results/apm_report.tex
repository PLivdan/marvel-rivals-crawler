...
\fancyfoot[C]{\thepage}\fancyfoot[R]{\scriptsize build \texttt{3b582569}}
...
{\small Season 9.5, PC ranked. Prepared 8 September 2026. Model fit \texttt{31cfdff}, report build \texttt{3b582569}.}
\end{center}
