...
\fancyfoot[C]{\thepage}\fancyfoot[R]{\scriptsize build \texttt{9b7d4f36}}
...
{\small Season 9.5, PC ranked. Prepared 8 September 2026. Model fit \texttt{31cfdff}, report build \texttt{9b7d4f36}.}
\end{center}
...
estimates is 0.869 and the mean absolute change 1.07 percentage points, and
the changes track team-up exposure (correlation 0.45 with the sum of a hero's positive
team-up premiums): Star-lord (+2.6), Cyclops (+2.6), and Peni Parker (+2.2) gain, while Daredevil (-3.0), Magik (-2.6), and The Thing (-2.3) lose. Neither version is
wrong. They answer different questions about the same hero.

After false-discovery-rate correction across all 2,399 interactions, 52
counters and 74 synergies are distinguishable from zero. The largest synergies are
Moon Knight with Blade (+8.1), Ultron with Adam Warlock (+7.7), and Squirrel Girl with Iron Man (+7.2), all of them designated team-ups. Of the 100 designated team-ups, 32
are significant, against 42 of the 1,015 other pairs, which is
the pattern one would expect if the game's designed synergies are the main synergies. The largest
counters are Black Widow over Ultron (+4.8), Ultron over White Fox (+4.7), and Deadpool (Duelist) over Deadpool (Strategist) (+3.9). Two folk beliefs can be checked directly. Black Panther against a
...
counter. Jeff starting alongside Devil Dinosaur is +1.9 points (standard error 0.8, $q=0.18$, 7,082 team instances). On the chronological holdout
the interaction blocks do not improve the holdout log loss, which moves from 0.6674 under the headline specification to 0.6677 with the synergy block and 0.6682 with both blocks. Individual interactions can be precisely estimated while the blocks as a whole, with 2,374 free parameters, add more noise than signal to prediction. The headline model therefore keeps the parsimonious team-up block, and the interactions are reported as a description of the sample rather than as part of the estimate (Appendix Table~\ref{tab:pwladder}). Appendix
...
\midrule
Black Widow over Ultron & +4.82\sym{***} & (1.01) & 3,256 & Moon Knight $\times$ Blade & +8.09\sym{***} & (0.85) & 4,378 \\
Ultron over White Fox & +4.68\sym{***} & (0.99) & 4,228 & Ultron $\times$ Adam Warlock & +7.66\sym{***} & (0.75) & 6,510 \\
Deadpool (Duelist) over Deadpool (Strategist) & +3.87\sym{**} & (1.07) & 3,133 & Squirrel Girl $\times$ Iron Man & +7.17\sym{***} & (0.94) & 3,394 \\
Venom over Squirrel Girl & +3.78\sym{***} & (0.97) & 3,421 & Iron Fist $\times$ White Fox & +6.76\sym{***} & (0.63) & 15,235 \\
Thor over Black Panther & +3.67\sym{***} & (0.82) & 5,728 & Gambit $\times$ Rogue & +6.51\sym{***} & (0.64) & 26,196 \\
Storm over Iron Fist & +3.57\sym{***} & (0.90) & 3,986 & Loki $\times$ Mantis & +4.73\sym{***} & (0.84) & 7,635 \\
Phoenix over Elsa Bloodstone & +3.34\sym{***} & (0.91) & 3,859 & Mantis $\times$ Adam Warlock & +4.00\sym{***} & (0.84) & 4,710 \\
Spider-man over Iron Man & +3.31\sym{***} & (0.74) & 6,082 & The Punisher $\times$ Rocket Raccoon & +3.98\sym{***} & (0.58) & 24,911 \\
Black Widow over Iron Man & +3.18\sym{**} & (0.88) & 4,090 & Luna Snow $\times$ White Fox & +3.80\sym{***} & (0.66) & 18,249 \\
Peni Parker over Thor & +3.08\sym{**} & (0.98) & 3,726 & Storm $\times$ Jeff The Land Shark & +3.79\sym{***} & (0.73) & 8,014 \\
White Fox over Wolverine & +2.97\sym{**} & (0.93) & 3,959 & Ultron $\times$ Devil Dinosaur & -3.62\sym{**} & (1.10) & 2,672 \\
Magik over Devil Dinosaur & +2.93\sym{***} & (0.64) & 11,037 & Rocket Raccoon $\times$ Invisible Woman & -3.62\sym{***} & (0.57) & 28,719 \\
Gambit over Angela & +2.91\sym{***} & (0.79) & 9,187 & Rocket Raccoon $\times$ Jeff The Land Shark & -3.59\sym{***} & (0.77) & 7,951 \\
Hela over Ultron & +2.84\sym{**} & (0.90) & 4,310 & Doctor Strange $\times$ Invisible Woman & +3.53\sym{***} & (0.52) & 45,963 \\
The Thing over Rogue & +2.71\sym{**} & (0.83) & 6,170 & Hela $\times$ Iron Man & -3.49\sym{**} & (0.99) & 2,852 \\
Daredevil over Black Cat & +2.70\sym{**} & (0.85) & 4,640 & Rocket Raccoon $\times$ Gambit & -3.43\sym{***} & (0.60) & 22,783 \\
Namor over Spider-man & +2.68\sym{***} & (0.63) & 9,237 & Mantis $\times$ Peni Parker & -3.39\sym{***} & (0.81) & 5,603 \\
Black Panther over Mantis & +2.58\sym{**} & (0.75) & 10,240 & Human Torch $\times$ Jubilee & +3.34\sym{***} & (0.60) & 21,864 \\
The Thing over Deadpool (Duelist) & +2.58\sym{**} & (0.78) & 6,657 & Gambit $\times$ Deadpool (Duelist) & +3.32\sym{***} & (0.65) & 15,503 \\
Cloak \& Dagger over Cyclops & +2.55\sym{***} & (0.57) & 36,351 & Adam Warlock $\times$ Elsa Bloodstone & -3.31\sym{**} & (1.00) & 3,209 \\
Rocket Raccoon over Squirrel Girl & +2.53\sym{**} & (0.81) & 6,380 & Loki $\times$ Devil Dinosaur & +3.30\sym{**} & (1.03) & 3,444 \\
Gambit over Wolverine & +2.51\sym{**} & (0.74) & 9,067 & Adam Warlock $\times$ Cyclops & -3.22\sym{**} & (0.91) & 3,993 \\
Devil Dinosaur over Magneto & +2.41\sym{***} & (0.57) & 26,012 & Doctor Strange $\times$ Angela & -3.12\sym{**} & (0.99) & 3,344 \\
Winter Soldier over Ultron & +2.41\sym{**} & (0.69) & 9,083 & Hela $\times$ Ultron & -3.01\sym{**} & (0.95) & 3,497 \\
Deadpool (Duelist) over Invisible Woman & +2.39\sym{**} & (0.71) & 13,683 & Namor $\times$ Gambit & -2.99\sym{***} & (0.64) & 14,862 \\
Iron Man over The Thing & +2.38\sym{**} & (0.77) & 6,517 & Rocket Raccoon $\times$ Cloak \& Dagger & -2.98\sym{***} & (0.53) & 40,371 \\
Human Torch over Jubilee & +2.28\sym{**} & (0.68) & 16,056 & Adam Warlock $\times$ Jubilee & +2.98\sym{***} & (0.76) & 6,613 \\
The Hood over Storm & +2.28\sym{***} & (0.60) & 18,350 & Cloak \& Dagger $\times$ Peni Parker & -2.97\sym{***} & (0.66) & 13,400 \\
Angela over Magneto & +2.25\sym{**} & (0.62) & 18,811 & Cloak \& Dagger $\times$ Invisible Woman & -2.92\sym{***} & (0.53) & 43,646 \\
The Thing over Magik & +2.21\sym{***} & (0.53) & 17,714 & Rocket Raccoon $\times$ Jubilee & -2.92\sym{***} & (0.53) & 34,943 \\
\bottomrule
\end{tabular}
}
\end{center}
\vspace{-2pt}
\noindent\begin{minipage}{\linewidth}\footnotesize
\emph{Notes.} The 30 largest counters and the 30 largest synergies among
those significant at $q<0.05$ after Benjamini--Hochberg correction across all 2,399
interactions (52 counters and 74 synergies are significant in total).
