...
The Thing & 5.46\sym{***} & (0.204) & [5.06, 5.86] & 0.000 \\
Magneto & 1.96\sym{***} & (0.139) & [1.69, 2.24] & 0.000 \\
Angela & 1.87\sym{***} & (0.261) & [1.36, 2.38] & 0.000 \\
Peni Parker & 1.51\sym{***} & (0.328) & [0.86, 2.15] & 0.000 \\
Hulk & 1.33\sym{***} & (0.219) & [0.90, 1.76] & 0.000 \\
Thor & 1.29\sym{***} & (0.219) & [0.86, 1.72] & 0.000 \\
The Hood & 0.45\sym{**} & (0.172) & [0.11, 0.78] & 0.012 \\
Devil Dinosaur & -0.03 & (0.231) & [-0.48, 0.42] & 0.907 \\
Groot & -0.67\sym{**} & (0.290) & [-1.23, -0.10] & 0.027 \\
Venom & -0.93\sym{***} & (0.219) & [-1.36, -0.51] & 0.000 \\
Doctor Strange & -0.98\sym{***} & (0.202) & [-1.37, -0.58] & 0.000 \\
Captain America & -1.22\sym{***} & (0.352) & [-1.91, -0.53] & 0.001 \\
Emma Frost & -1.77\sym{***} & (0.192) & [-2.15, -1.39] & 0.000 \\
Rogue & -3.41\sym{***} & (0.344) & [-4.09, -2.74] & 0.000 \\
Deadpool (Vanguard) & -4.86\sym{***} & (0.252) & [-5.36, -4.37] & 0.000 \\
\addlinespace[4pt]
\multicolumn{5}{l}{\emph{Panel B: Damage} \ (27 heroes)} \\[2pt]
Black Cat & 4.85\sym{***} & (0.260) & [4.34, 5.36] & 0.000 \\
Magik & 3.47\sym{***} & (0.219) & [3.04, 3.90] & 0.000 \\
Storm & 3.09\sym{***} & (0.305) & [2.49, 3.68] & 0.000 \\
Daredevil & 2.92\sym{***} & (0.217) & [2.50, 3.35] & 0.000 \\
Mister Fantastic & 2.52\sym{***} & (0.351) & [1.83, 3.21] & 0.000 \\
Iron Man & 1.34\sym{***} & (0.279) & [0.79, 1.89] & 0.000 \\
Iron Fist & 1.32\sym{***} & (0.224) & [0.88, 1.76] & 0.000 \\
Hela & 1.14\sym{***} & (0.199) & [0.75, 1.53] & 0.000 \\
Winter Soldier & 1.00\sym{***} & (0.141) & [0.73, 1.28] & 0.000 \\
Wolverine & 0.82\sym{**} & (0.317) & [0.20, 1.44] & 0.012 \\
Spider-man & 0.58\sym{***} & (0.175) & [0.24, 0.93] & 0.001 \\
...
Deadpool (Duelist) & -0.67\sym{***} & (0.220) & [-1.10, -0.24] & 0.003 \\
Namor & -0.82\sym{***} & (0.243) & [-1.30, -0.34] & 0.001 \\
Hawkeye & -1.22\sym{***} & (0.341) & [-1.89, -0.55] & 0.001 \\
The Punisher & -1.81\sym{***} & (0.262) & [-2.33, -1.30] & 0.000 \\
Star-lord & -2.41\sym{***} & (0.300) & [-3.00, -1.82] & 0.000 \\
Scarlet Witch & -2.49\sym{***} & (0.414) & [-3.30, -1.68] & 0.000 \\
Squirrel Girl & -3.78\sym{***} & (0.350) & [-4.46, -3.09] & 0.000 \\
Cyclops & -4.04\sym{***} & (0.195) & [-4.42, -3.66] & 0.000 \\
Phoenix & -4.28\sym{***} & (0.345) & [-4.96, -3.61] & 0.000 \\
\addlinespace[4pt]
\multicolumn{5}{l}{\emph{Panel C: Support} \ (13 heroes)} \\[2pt]
Mantis & 6.76\sym{***} & (0.181) & [6.40, 7.11] & 0.000 \\
Rocket Raccoon & 4.14\sym{***} & (0.150) & [3.85, 4.44] & 0.000 \\
Ultron & 3.59\sym{***} & (0.297) & [3.01, 4.17] & 0.000 \\
Adam Warlock & 2.08\sym{***} & (0.315) & [1.47, 2.70] & 0.000 \\
Loki & 1.18\sym{***} & (0.268) & [0.65, 1.70] & 0.000 \\
Cloak \& Dagger & -0.04 & (0.170) & [-0.37, 0.29] & 0.852 \\
Gambit & -0.30 & (0.210) & [-0.71, 0.11] & 0.178 \\
Invisible Woman & -1.38\sym{***} & (0.151) & [-1.67, -1.08] & 0.000 \\
Jeff The Land Shark & -1.75\sym{***} & (0.233) & [-2.21, -1.29] & 0.000 \\
Jubilee & -1.91\sym{***} & (0.172) & [-2.25, -1.58] & 0.000 \\
Luna Snow & -3.01\sym{***} & (0.167) & [-3.33, -2.68] & 0.000 \\
White Fox & -3.48\sym{***} & (0.208) & [-3.89, -3.07] & 0.000 \\
Deadpool (Strategist) & -5.89\sym{***} & (0.210) & [-6.30, -5.48] & 0.000 \\
\end{longtable}
}
...
\sym{**}~$q<0.05$, \sym{***}~$q<0.01$; 10 of the 55 are not distinguishable from
their role average. Sample: 482,997 matches crawled, less
...
\bottomrule
\endlastfoot
\multicolumn{5}{l}{\emph{Panel A: Tank}} \\[2pt]
...
\addlinespace[4pt]
\multicolumn{5}{l}{\emph{Panel B: Damage}} \\[2pt]
...
\addlinespace[4pt]
\multicolumn{5}{l}{\emph{Panel C: Support}} \\[2pt]
...
477,483 matches. Effect magnitude rises monotonically with how much
...
\noindent\begin{minipage}{\linewidth}\footnotesize
\emph{Notes.} All 100 team-ups are listed. Read down the left column, then the
