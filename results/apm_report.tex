...
\fancyfoot[C]{\thepage}\fancyfoot[R]{\scriptsize build \texttt{9e494b78}}
...
{\small Season 9.5, PC ranked. Prepared 8 September 2026. Model fit \texttt{31cfdff}, report build \texttt{9e494b78}.}
\end{center}
...
With nearly half a million observations and 187 parameters, in-sample fit says relatively
little. I instead test whether the estimated structure survives a chronological holdout.

I therefore estimate the model on the first 437,453 matches and evaluate it on the final
40,030, corresponding to the last 7 days of the sample. The split is
...
coefficient for every hero pair that starts together at least 2,500 times (a synergy,
1,115 pairs) and one for every pair that starts on opposite sides at least 2,500
times (a counter, 1,284 pairs), on the same starting lineups as the headline model. The
...
instead. The rank correlation with the headline estimates is 0.870 and the mean
absolute change 0.98 percentage points. Heroes whose most common pairings carry
negative deviations rise, as for Cyclops (+3.2), Star-lord (+2.1), and Gambit (+1.9), and heroes whose common pairings carry
positive deviations fall, as for Daredevil (-2.4), Magik (-2.0), and The Thing (-1.9). Neither version is wrong. They answer
different questions about the same hero, and the headline version answers the one a player
choosing a hero actually faces.

After false-discovery-rate correction across all 2,399 interactions, 51
counters and 68 synergies are distinguishable from zero. The largest synergies are
the designated team-ups, led by Ultron with Adam Warlock (+8.8), Moon Knight with Blade (+8.5), and Squirrel Girl with Iron Man (+8.0), and 30 of the 100
team-ups are significant against 38 of the 1,015 other pairs,
which is the pattern one would expect if the game's designed synergies are the main synergies.
Beyond them, 14 pairs do better together than their individual effects predict, led by
Adam Warlock with Jubilee (+3.9), Loki with Devil Dinosaur (+3.5), and Adam Warlock with Invisible Woman (+3.3), and 24 do worse, led by Rocket Raccoon with Jeff The Land Shark (-3.5), Rocket Raccoon with Invisible Woman (-3.3), and Rocket Raccoon with Gambit (-3.1). The negative pairs are
...
fielded by less coordinated teams. The largest counters are Black Widow over Ultron (+4.8), Ultron over White Fox (+4.7), and Deadpool (Duelist) over Deadpool (Strategist) (+3.9). Two folk beliefs can be checked directly. Black Panther against a
starting Thing is -2.2 points (standard error 0.8, $q=0.05$, 7,099 matches), so most of the raw -5.6-point gap in Black Panther's
win rate when a Thing is on the other side is The Thing's own strength rather than a specific
counter. Jeff starting alongside Devil Dinosaur is +1.9 points (standard error 0.9, $q=0.21$, 7,082 team instances). On the chronological holdout
the interaction blocks do not improve the holdout log loss, which moves from 0.6674 under the headline specification to 0.6677 with the synergy block and 0.6681 with both blocks. Individual interactions can be precisely estimated while the blocks as a whole, with 2,374 free parameters, add more noise than signal to prediction. The headline model therefore keeps the parsimonious team-up block, and the interactions are reported as a description of the sample rather than as part of the estimate (Appendix Table~\ref{tab:pwladder}). Appendix
...
23 of the 55 heroes differ by more than two standard errors between the bottom and
top thirds, 12 gaining with rank and 11 losing. The largest
gains are Wolverine (-1.4 to +2.0) and Elsa Bloodstone (-1.7 to +1.0), and the largest loss is Black Panther (+0.9 to -1.4). For heroes like
...
+ all pairwise counters & 2374 & 0.6681 \\
\bottomrule
\end{tabular}
\begin{tablenotes}[flushleft]\footnotesize
\item Same chronological split as Table~\ref{tab:ladder}. The synergy block replaces the
designated team-up block, which it contains; pairs below 2,500 co-occurrences carry no
...
\begin{axis}[
  ...
  xmin=-8, xmax=9, ymin=0, ymax=58.5,
  xlabel={APM, percentage points relative to the average hero of the same role},
  label style={font=\footnotesize}, tick label style={font=\scriptsize},
  ytick={57.5,56.5,55.5,54.5,53.5,52.5,51.5,50.5,49.5,48.5,47.5,46.5,45.5,44.5,43.5,41.5,40.5,39.5,38.5,37.5,36.5,35.5,34.5,33.5,32.5,31.5,30.5,29.5,28.5,27.5,26.5,25.5,24.5,23.5,22.5,21.5,20.5,19.5,18.5,17.5,16.5,15.5,13.5,12.5,11.5,10.5,9.5,8.5,7.5,6.5,5.5,4.5,3.5,2.5,1.5}, yticklabels={{Thor$^{*}$},{Peni Parker},{Magneto$^{*}$},{Groot},{The Hood$^{*}$},{Rogue},{Devil Dinosaur},{Angela},{Venom},{Emma Frost},{The Thing},{Hulk},{Doctor Strange$^{*}$},{Captain America},{Deadpool (Vanguard)$^{*}$},{Wolverine$^{*}$},{Elsa Bloodstone$^{*}$},{Phoenix$^{*}$},{Black Cat$^{*}$},{Moon Knight},{Daredevil},{Iron Fist},{Black Widow},{Psylocke},{Hela},{Star-lord},{Deadpool (Duelist)},{Spider-man},{Storm},{Mister Fantastic},{Human Torch},{Squirrel Girl},{Cyclops},{Magik},{The Punisher},{Blade},{Winter Soldier$^{*}$},{Scarlet Witch},{Namor$^{*}$},{Iron Man$^{*}$},{Hawkeye$^{*}$},{Black Panther$^{*}$},{Mantis$^{*}$},{Loki$^{*}$},{Invisible Woman$^{*}$},{Jeff The Land Shark$^{*}$},{Gambit$^{*}$},{Luna Snow},{Rocket Raccoon},{Jubilee},{Cloak \& Dagger$^{*}$},{White Fox},{Deadpool (Strategist)$^{*}$},{Adam Warlock$^{*}$},{Ultron$^{*}$}}, yticklabel style={font=\tiny},
  y axis line style={draw=none},
  legend style={at={(0.98,0.985)}, anchor=north east, font=\scriptsize, draw=none, fill=none, cells={anchor=west}},
  clip=false,
]
\draw[dashed, thin] (axis cs:0,0) -- (axis cs:0,58.5);
\draw[black!35, thin] (axis cs:-8.0,42.5) -- (axis cs:9.0,42.5);
\draw[black!35, thin] (axis cs:-8.0,14.5) -- (axis cs:9.0,14.5);
\draw[thin] (axis cs:0.506,57.5) -- (axis cs:2.041,57.5);
\draw[thin] (axis cs:0.867,56.5) -- (axis cs:2.221,56.5);
\draw[thin] (axis cs:1.458,55.5) -- (axis cs:2.717,55.5);
\draw[thin] (axis cs:-0.958,54.5) -- (axis cs:0.191,54.5);
\draw[thin] (axis cs:-0.240,53.5) -- (axis cs:0.788,53.5);
\draw[thin] (axis cs:-3.793,52.5) -- (axis cs:-3.296,52.5);
\draw[thin] (axis cs:-0.088,51.5) -- (axis cs:-0.190,51.5);
\draw[thin] (axis cs:2.140,50.5) -- (axis cs:1.815,50.5);
\draw[thin] (axis cs:-0.702,49.5) -- (axis cs:-1.125,49.5);
\draw[thin] (axis cs:-1.534,48.5) -- (axis cs:-1.993,48.5);
\draw[thin] (axis cs:5.682,47.5) -- (axis cs:5.053,47.5);
\draw[thin] (axis cs:1.610,46.5) -- (axis cs:0.962,46.5);
\draw[thin] (axis cs:-0.507,45.5) -- (axis cs:-1.615,45.5);
\draw[thin] (axis cs:-0.540,44.5) -- (axis cs:-1.800,44.5);
\draw[thin] (axis cs:-3.901,43.5) -- (axis cs:-5.770,43.5);
\draw[thin] (axis cs:-1.430,41.5) -- (axis cs:2.038,41.5);
\draw[thin] (axis cs:-1.704,40.5) -- (axis cs:0.973,40.5);
\draw[thin] (axis cs:-5.022,39.5) -- (axis cs:-2.809,39.5);
\draw[thin] (axis cs:4.907,38.5) -- (axis cs:6.789,38.5);
\draw[thin] (axis cs:-0.209,37.5) -- (axis cs:0.658,37.5);
\draw[thin] (axis cs:2.807,36.5) -- (axis cs:3.530,36.5);
\draw[thin] (axis cs:0.749,35.5) -- (axis cs:1.471,35.5);
\draw[thin] (axis cs:-0.190,34.5) -- (axis cs:0.531,34.5);
\draw[thin] (axis cs:-0.579,33.5) -- (axis cs:-0.066,33.5);
\draw[thin] (axis cs:0.964,32.5) -- (axis cs:1.433,32.5);
\draw[thin] (axis cs:-2.259,31.5) -- (axis cs:-1.866,31.5);
\draw[thin] (axis cs:-0.873,30.5) -- (axis cs:-0.568,30.5);
\draw[thin] (axis cs:0.359,29.5) -- (axis cs:0.663,29.5);
\draw[thin] (axis cs:2.994,28.5) -- (axis cs:2.910,28.5);
\draw[thin] (axis cs:2.615,27.5) -- (axis cs:2.361,27.5);
\draw[thin] (axis cs:-0.217,26.5) -- (axis cs:-0.732,26.5);
\draw[thin] (axis cs:-3.260,25.5) -- (axis cs:-3.958,25.5);
\draw[thin] (axis cs:-3.690,24.5) -- (axis cs:-4.394,24.5);
\draw[thin] (axis cs:3.704,23.5) -- (axis cs:2.974,23.5);
\draw[thin] (axis cs:-1.504,22.5) -- (axis cs:-2.501,22.5);
\draw[thin] (axis cs:0.125,21.5) -- (axis cs:-0.879,21.5);
\draw[thin] (axis cs:1.480,20.5) -- (axis cs:0.321,20.5);
\draw[thin] (axis cs:-2.323,19.5) -- (axis cs:-3.556,19.5);
\draw[thin] (axis cs:0.075,18.5) -- (axis cs:-1.690,18.5);
\draw[thin] (axis cs:2.061,17.5) -- (axis cs:0.259,17.5);
\draw[thin] (axis cs:-0.435,16.5) -- (axis cs:-2.492,16.5);
\draw[thin] (axis cs:0.854,15.5) -- (axis cs:-1.398,15.5);
\draw[thin] (axis cs:5.553,13.5) -- (axis cs:7.787,13.5);
\draw[thin] (axis cs:0.053,12.5) -- (axis cs:1.972,12.5);
\draw[thin] (axis cs:-1.932,11.5) -- (axis cs:-0.680,11.5);
\draw[thin] (axis cs:-2.239,10.5) -- (axis cs:-1.059,10.5);
\draw[thin] (axis cs:-0.724,9.5) -- (axis cs:0.404,9.5);
\draw[thin] (axis cs:-3.068,8.5) -- (axis cs:-2.702,8.5);
\draw[thin] (axis cs:4.168,7.5) -- (axis cs:3.781,7.5);
\draw[thin] (axis cs:-1.651,6.5) -- (axis cs:-2.118,6.5);
\draw[thin] (axis cs:0.231,5.5) -- (axis cs:-0.709,5.5);
\draw[thin] (axis cs:-3.066,4.5) -- (axis cs:-4.090,4.5);
\draw[thin] (axis cs:-5.044,3.5) -- (axis cs:-6.662,3.5);
\draw[thin] (axis cs:3.021,2.5) -- (axis cs:1.248,2.5);
\draw[thin] (axis cs:4.698,1.5) -- (axis cs:2.827,1.5);
...
\node[anchor=west, font=\scriptsize\itshape] at (axis cs:-7.85,58.0) {Tanks};
\node[anchor=west, font=\scriptsize\itshape] at (axis cs:-7.85,42.0) {Damages};
\node[anchor=west, font=\scriptsize\itshape] at (axis cs:-7.85,14.0) {Supports};
\end{axis}
\end{tikzpicture}
...
477,483 matches, split by the mean pre-match rank score of their twelve players (thirds
of 159,161 matches; boundaries 4,443 and 4,649). Open circles are the
...
two standard errors (HC1): 23 of 55, 12 gaining with rank and 11
...
\midrule
Black Widow over Ultron & +4.82\sym{***} & (1.01) & 3,256 & Adam Warlock $\times$ Jubilee & +3.90\sym{***} & (0.77) & 6,613 \\
Ultron over White Fox & +4.70\sym{***} & (0.99) & 4,228 & Rocket Raccoon $\times$ Jeff The Land Shark & -3.51\sym{***} & (0.76) & 7,951 \\
Deadpool (Duelist) over Deadpool (Strategist) & +3.85\sym{**} & (1.07) & 3,133 & Loki $\times$ Devil Dinosaur & +3.50\sym{**} & (1.03) & 3,444 \\
Venom over Squirrel Girl & +3.75\sym{***} & (0.97) & 3,421 & Rocket Raccoon $\times$ Invisible Woman & -3.29\sym{***} & (0.55) & 28,719 \\
Thor over Black Panther & +3.68\sym{***} & (0.82) & 5,728 & Adam Warlock $\times$ Invisible Woman & +3.26\sym{***} & (0.83) & 5,394 \\
Storm over Iron Fist & +3.57\sym{***} & (0.90) & 3,986 & Cloak \& Dagger $\times$ Adam Warlock & +3.24\sym{***} & (0.75) & 7,961 \\
Phoenix over Elsa Bloodstone & +3.37\sym{***} & (0.91) & 3,859 & Gambit $\times$ Deadpool (Duelist) & +3.17\sym{***} & (0.65) & 15,503 \\
Spider-man over Iron Man & +3.31\sym{***} & (0.74) & 6,082 & Rocket Raccoon $\times$ Gambit & -3.13\sym{***} & (0.59) & 22,783 \\
Black Widow over Iron Man & +3.17\sym{**} & (0.88) & 4,090 & Hela $\times$ Iron Man & -3.08\sym{**} & (0.99) & 2,852 \\
Peni Parker over Thor & +3.09\sym{**} & (0.98) & 3,726 & Namor $\times$ Gambit & -3.05\sym{***} & (0.65) & 14,862 \\
White Fox over Wolverine & +2.97\sym{**} & (0.93) & 3,959 & Mantis $\times$ Peni Parker & -2.92\sym{**} & (0.82) & 5,603 \\
Magik over Devil Dinosaur & +2.93\sym{***} & (0.64) & 11,037 & Wolverine $\times$ The Thing & -2.83\sym{**} & (0.82) & 4,881 \\
Gambit over Angela & +2.91\sym{***} & (0.79) & 9,187 & Adam Warlock $\times$ Cyclops & -2.77\sym{**} & (0.90) & 3,993 \\
Hela over Ultron & +2.87\sym{**} & (0.90) & 4,310 & Spider-man $\times$ Angela & -2.75\sym{***} & (0.73) & 6,557 \\
The Thing over Rogue & +2.72\sym{**} & (0.83) & 6,170 & Cloak \& Dagger $\times$ Peni Parker & -2.74\sym{***} & (0.67) & 13,400 \\
Daredevil over Black Cat & +2.70\sym{**} & (0.85) & 4,640 & Rocket Raccoon $\times$ Cloak \& Dagger & -2.71\sym{***} & (0.52) & 40,371 \\
Namor over Spider-man & +2.68\sym{***} & (0.63) & 9,237 & Doctor Strange $\times$ Mister Fantastic & -2.66\sym{**} & (0.81) & 5,164 \\
Black Panther over Mantis & +2.58\sym{**} & (0.75) & 10,240 & Cloak \& Dagger $\times$ Invisible Woman & -2.64\sym{***} & (0.52) & 43,646 \\
The Thing over Deadpool (Duelist) & +2.57\sym{**} & (0.78) & 6,657 & Rocket Raccoon $\times$ Jubilee & -2.63\sym{***} & (0.53) & 34,943 \\
Rocket Raccoon over Squirrel Girl & +2.54\sym{**} & (0.81) & 6,380 & Star-lord $\times$ Invisible Woman & -2.55\sym{**} & (0.70) & 10,519 \\
Cloak \& Dagger over Cyclops & +2.53\sym{***} & (0.57) & 36,351 & Doctor Strange $\times$ Magneto & -2.40\sym{***} & (0.48) & 25,549 \\
Gambit over Wolverine & +2.50\sym{**} & (0.74) & 9,067 & Invisible Woman $\times$ Gambit & -2.39\sym{***} & (0.58) & 25,710 \\
Devil Dinosaur over Magneto & +2.43\sym{***} & (0.57) & 26,012 & Cloak \& Dagger $\times$ Gambit & -2.36\sym{***} & (0.54) & 36,652 \\
Winter Soldier over Ultron & +2.42\sym{**} & (0.69) & 9,083 & Black Panther $\times$ The Thing & -2.35\sym{**} & (0.74) & 6,748 \\
Deadpool (Duelist) over Invisible Woman & +2.39\sym{**} & (0.71) & 13,683 & Devil Dinosaur $\times$ Jubilee & +2.23\sym{**} & (0.64) & 21,719 \\
Iron Man over The Thing & +2.37\sym{**} & (0.77) & 6,517 & Mister Fantastic $\times$ Gambit & +2.20\sym{**} & (0.73) & 7,586 \\
Human Torch over Jubilee & +2.27\sym{**} & (0.69) & 16,056 & Invisible Woman $\times$ Devil Dinosaur & +2.14\sym{**} & (0.67) & 16,544 \\
The Hood over Storm & +2.27\sym{***} & (0.60) & 18,350 & Luna Snow $\times$ Daredevil & +2.12\sym{**} & (0.62) & 16,200 \\
Angela over Magneto & +2.25\sym{**} & (0.62) & 18,811 & Rocket Raccoon $\times$ Scarlet Witch & +2.09\sym{**} & (0.67) & 8,347 \\
The Thing over Magik & +2.20\sym{***} & (0.53) & 17,714 & Magik $\times$ Deadpool (Strategist) & +2.08\sym{**} & (0.68) & 9,771 \\
\bottomrule
\end{tabular}
}
\end{center}
\vspace{-2pt}
\noindent\begin{minipage}{\linewidth}\footnotesize
\emph{Notes.} The 30 largest counters and the 30 largest synergies, by
absolute size, among those significant at $q<0.05$ after Benjamini--Hochberg correction across
all 2,399 interactions (51 counters and 68 synergies are
significant in total, 30 of the latter designated team-ups, which are listed in
