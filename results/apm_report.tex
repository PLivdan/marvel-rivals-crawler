...
\fancyfoot[C]{\thepage}\fancyfoot[R]{\scriptsize build \texttt{79c8d969}}
...
{\small Season 9.5, PC ranked. Prepared 8 September 2026. Model fit \texttt{31cfdff}, report build \texttt{79c8d969}.}
\end{center}
...
\texttt{results/apm\_pairwise\_counter\_W0\_specE.csv} and
\texttt{results/apm\_pairwise\_synergy\_W0\_specE.csv}.
\end{minipage}
\end{landscape}
